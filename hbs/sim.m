...
fprintf('mean savings rate of type 1: %3.3f and type 2: %3.3f \n', mean(optst_65(:,1).*(1-darr_45{1,1}.taxrate))./2, mean(optst_65(:,2).*(1-darr_45{1,1}.taxrate))./2);
...
pencons_simtot65=penconssim(pmax,N,draws,arr,darr_45{1,1}.renteA,darr_45{1,1}.rente,darr_45{1,1}.annuA,darr_45{1,1}.annu,optst_65,darr_45{1,1}.mon,randnrdr,era);
...
fprintf('mean savings rate of type 1: %3.3f and type 2: %3.3f \n', mean(optst_67(:,1).*(1-darr_45r{1,1}.taxrate))./2, mean(optst_67(:,2).*(1-darr_45r{1,1}.taxrate))./2)
end
...
pencons_simtot67=penconssim(pmax,N,draws,arr,darr_45r{1,1}.renteA,darr_45r{1,1}.rente,darr_45r{1,1}.annuA,darr_45r{1,1}.annu,optst_67,darr_45r{1,1}.mon,randnrdr,era);
